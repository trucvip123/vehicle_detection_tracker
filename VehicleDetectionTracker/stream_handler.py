        ...
        while True:
            ...
            try:
                ...
                try:
                    ...
                    # with time_block("[FRAME_READ]", self.log):
                ...
                # with time_block("[FRAME_RESIZE]", self.log):
                ...
                # === TIME BLOCK: PROCESS FRAME ===
                # with time_block("[FRAME_PROCESS]", self.log):
                # Process frame
                try:
                    frame_processor.process_frame_streaming(
