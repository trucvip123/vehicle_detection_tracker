    ...
    try:
        ...
        if torch.cuda.is_available():
            ...
            if "+cpu" in torch.__version__:
                ...
                print("  ⚠ Có thể do driver NVIDIA chưa được cài đặt hoặc không tương thích")
    ...
    try:
        ...
        if paddle.device.is_compiled_with_cuda():
            ...
            try:
                ...
                print("     python -m pip install paddlepaddle-gpu==2.5.2.post117 -f https://www.paddlepaddle.org.cn/whl/windows/mkl/avx/stable.html")
                return False
        else:
